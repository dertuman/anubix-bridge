...
const ws = new WebSocket('ws://localhost:3456/ws/SESSION_ID?key=your-shared-secret');
...
4. Your stable URL is now `https://bridge.yourdomain.com`
...
- **REST:** `https://bridge.yourdomain.com/api/sessions`
- **WebSocket:** `wss://bridge.yourdomain.com/ws/:sessionId?key=your-shared-secret`
